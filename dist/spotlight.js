...
/* harmony import */ var _spotlight_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./spotlight_type */ "./src/spotlight_type.js");
/* harmony import */ var _module_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module_helper */ "./src/module_helper.js");
...
function () {
  function Graph(tag) {
    ...
    this.d3Inst = _module_helper__WEBPACK_IMPORTED_MODULE_1__["default"].select(tag);
    this.context = {
      shape: {},
      path: {},
      port: {},
    ...
    this.markup = 'svg';
    this.type = _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].GRAPH;
  }
  ...
  _createClass(Graph, [{
    ...
    value: function elementExist(element) {
      ...
      return this.context.shape.hasOwnProperty(element.id) || this.context.path.hasOwnProperty(element.id) || this.context.port.hasOwnProperty(element.id) || this.context.group.hasOwnProperty(element.id);
    }
  }, {
    key: "registElement",
    value: function registElement(element) {
      if (element.id === undefined || !this.__allowRegist(element)) {
        return false;
      }

      if (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].SHAPE) {
        this.context.shape[element.id] = element;
        return true;
      } else if (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].PORT) {
        this.context.port[element.id] = element;
        return true;
      } else if (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].GROUP) {
        this.context.group[element.id] = element;
        return true;
      } else if (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].PATH) {
    ...
    key: "deRegistElement",
    value: function deRegistElement(element) {
      if (element.id === undefined || !this.__allowDeRegist(element)) {
        return false;
      }

      if (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].GROUP) {
        delete this.context.group[element.id];
        return true;
      } else if (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].SHAPE) {
    ...
    key: "__legaledElement",
    value: function __legaledElement(element) {
      return element != null && element.id != null && (element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].SHAPE || element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].PATH || element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].PORT || element.type === _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].GROUP);
    }
  }, {
    key: "__allowRegist",
    value: function __allowRegist(element) {
      return !this.elementExist(element.id);
    }
  }, {
    key: "__allowDeRegist",
    value: function __allowDeRegist(element) {
      return this.elementExist(element.id);
    }
  }]);
...
/* harmony import */ var _shapes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shapes.js */ "./src/shapes.js");


var graph = new _graph_js__WEBPACK_IMPORTED_MODULE_0__["default"]('svg');
var rec = new _shapes_js__WEBPACK_IMPORTED_MODULE_1__["Rect"](graph);
rec.setID('abc');
rec.init();
console.log(graph);
...
/*!***********************!*\
  !*** ./src/shapes.js ***!
  \***********************/
/*! exports provided: Shape, Rect, Ellipse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function () {
  function Shape(graph) {
    ...
    this.graph = graph;
    this.type = _spotlight_type__WEBPACK_IMPORTED_MODULE_0__["default"].SHAPE;
    this.d3Inst = null;
    this.id = null;
    this.markup = null;
  }
...
function (_Shape) {
  ...
  function Rect(graph) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Rect).call(this, graph));
    _this.markup = 'rect';
    return _this;
  }
...
function (_Shape2) {
  ...
  function Ellipse(graph) {
    var _this2;

    _classCallCheck(this, Ellipse);

    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Ellipse).call(this, graph));
    _this2.markup = 'ellipse';
    return _this2;
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SpotlightType; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function SpotlightType() {
    _classCallCheck(this, SpotlightType);
  }

  _createClass(SpotlightType, null, [{
    key: "SHAPE",
    get: function get() {
      return 'shape';
    }
